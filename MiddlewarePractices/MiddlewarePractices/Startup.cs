...
using MiddlewarePraxtices.Middlewares;
...
namespace MiddlewarePractices
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
           ...
           /* app.Run(async contect => Console.WriteLine("Middleware 1."));
            app.Run(async context => Console.WriteLine("Middleware 2."));  Run metodu kısa devre yaptırır ve kendisinden sonraki çalışmaz*/
         ...
         /*   app.Use(async (context, next) => 
           ...
           /* app.Use(async (context, next) => 
            {
                Console.WriteLine("Use Middleware tetiklendi.1");
                await next.Invoke();
